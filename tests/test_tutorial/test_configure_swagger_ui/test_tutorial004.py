...
from docs_src.configure_swagger_ui.tutorial004 import app
...
def test_swagger_ui():
    ...
    assert '"defaultModelsExpandDepth": 2,' in response.text, (
        "custom defaultModelsExpandDepth should be included"
    )
